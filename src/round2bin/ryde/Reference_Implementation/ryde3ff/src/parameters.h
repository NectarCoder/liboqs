...
#ifndef RYDE_3FF_PARAMETER_H
#define RYDE_3FF_PARAMETER_H

#define RYDE_NAME "RYDE-3FF"             /**< RYDE variant name */
...
#define RYDE_SIGNATURE_BYTES 11672       /**< Signature size */
...
#define RYDE_PARAM_TAU 47                /**< Parameter tau of the scheme (number of iterations) */
#define RYDE_PARAM_TAU_1 47              /**< Parameter tau_1 of the scheme (number of iterations concerning N1) */
...
#define RYDE_PARAM_TREE_LEAVES 1504      /**< Number of leaves in the tree */

#define RYDE_PARAM_CHALLENGE_1_BYTES 305 /**< Number of bytes required to store the first challenge */
#define RYDE_PARAM_CHALLENGE_2_BYTES 30  /**< Number of bytes required to store the second challenge */
...
#define RYDE_PARAM_T_OPEN 200            /**< Maximum sibling path length allowed */

#endif //RYDE_3FF_PARAMETER_H
