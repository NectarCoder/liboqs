...
#define RYDE_PARAM_TAU 27                /**< Parameter tau of the scheme (number of iterations) */
#define RYDE_PARAM_TAU_1 27              /**< Parameter tau_1 of the scheme (number of iterations concerning N1) */
...
#define RYDE_PARAM_TREE_LEAVES 6912      /**< Number of leaves in the tree */
...
#define RYDE_PARAM_T_OPEN 178            /**< Maximum sibling path length allowed */
