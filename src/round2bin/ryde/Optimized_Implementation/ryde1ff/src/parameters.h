...
#ifndef RYDE_1FF_PARAMETER_H
#define RYDE_1FF_PARAMETER_H

#define RYDE_NAME "RYDE-1FF"             /**< RYDE variant name */
...
#define RYDE_SIGNATURE_BYTES 4976        /**< Signature size */
...
#define RYDE_PARAM_TAU 30                /**< Parameter tau of the scheme (number of iterations) */
#define RYDE_PARAM_TAU_1 30              /**< Parameter tau_1 of the scheme (number of iterations concerning N1) */
...
#define RYDE_PARAM_TREE_LEAVES 960       /**< Number of leaves in the tree */

#define RYDE_PARAM_CHALLENGE_1_BYTES 159 /**< Number of bytes required to store the first challenge */
#define RYDE_PARAM_CHALLENGE_2_BYTES 19  /**< Number of bytes required to store the second challenge */
#define RYDE_PARAM_W_BYTES 1             /**< Number of bytes in the second hash to be zero */
#define RYDE_PARAM_W_MASK 0xff           /**< Mask for the most significant byte in the second hash */
#define RYDE_PARAM_T_OPEN 126            /**< Maximum sibling path length allowed */

#endif //RYDE_1FF_PARAMETER_H
