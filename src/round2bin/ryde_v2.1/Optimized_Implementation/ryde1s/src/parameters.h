...
#define RYDE_SIGNATURE_BYTES 3115        /**< Signature size */
...
#define RYDE_PARAM_TAU 12                /**< Parameter tau of the scheme (number of iterations) */
#define RYDE_PARAM_TAU_1 12              /**< Parameter tau_1 of the scheme (number of iterations concerning N1) */
...
#define RYDE_PARAM_TREE_LEAVES 24576     /**< Number of leaves in the tree */
