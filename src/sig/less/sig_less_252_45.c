...
OQS_SIG *OQS_SIG_less_252_45_new(void) {
	...
	sig->keypair = OQS_SIG_less_252_45_keypair;
	sig->sign = OQS_SIG_less_252_45_sign;
	sig->verify = OQS_SIG_less_252_45_verify;
	sig->sign_with_ctx_str = OQS_SIG_less_252_45_sign_with_ctx_str;
	sig->verify_with_ctx_str = OQS_SIG_less_252_45_verify_with_ctx_str;
