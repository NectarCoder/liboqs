 ...
 *
 * \param[out] public_key    Pointer to the buffer for the public key (OQS_SIG_perk_128_fast_3_length_public_key bytes).
 * \param[out] secret_key    Pointer to the buffer for the secret key (OQS_SIG_perk_128_fast_3_length_secret_key bytes).
 ...
 *
 * \param[out] signature       Pointer to the buffer for the signature (OQS_SIG_perk_128_fast_3_length_signature bytes).
 * \param[out] signature_len   Pointer to the length of the signature (always OQS_SIG_perk_128_fast_3_length_signature).
 * \param[in]  message         Pointer to the message to be signed.
 * \param[in]  message_len     Length of the message to be signed.
 * \param[in]  secret_key      Pointer to the secret key (OQS_SIG_perk_128_fast_3_length_secret_key bytes).
 * \return OQS_SUCCESS or OQS_ERROR
 */
 ...
 * \param[in]  signature        Pointer to the signature (OQS_SIG_perk_128_fast_3_length_signature bytes).
 * \param[in]  signature_len    Length of the signature.
 * \param[in]  public_key       Pointer to the public key (OQS_SIG_perk_128_fast_3_length_public_key bytes).
 * \return OQS_SUCCESS or OQS_ERROR
 */
 ...
 * \warning The secret key contains the public key as a suffix.
 *
 * \param[out] public_key    Pointer to the buffer for the public key (OQS_SIG_perk_128_short_3_length_public_key bytes).
 * \param[out] secret_key    Pointer to the buffer for the secret key (OQS_SIG_perk_128_short_3_length_secret_key bytes).
 * \return OQS_SUCCESS or OQS_ERROR
 */
 ...
 *
 * \param[out] signature       Pointer to the buffer for the signature (OQS_SIG_perk_128_short_3_length_signature bytes).
 * \param[out] signature_len   Pointer to the length of the signature (always OQS_SIG_perk_128_short_3_length_signature).
 * \param[in]  message         Pointer to the message to be signed.
 * \param[in]  message_len     Length of the message to be signed.
 * \param[in]  secret_key      Pointer to the secret key (OQS_SIG_perk_128_short_3_length_secret_key bytes).
 * \return OQS_SUCCESS or OQS_ERROR
 */
 ...
 * \param[in]  message          Pointer to the message.
 * \param[in]  message_len      Length of the message.
 * \param[in]  signature        Pointer to the signature (OQS_SIG_perk_128_short_3_length_signature bytes).
 * \param[in]  signature_len    Length of the signature.
 * \param[in]  public_key       Pointer to the public key (OQS_SIG_perk_128_short_3_length_public_key bytes).
 * \return OQS_SUCCESS or OQS_ERROR
 */
 ...
 * \warning The secret key contains the public key as a suffix.
 *
 * \param[out] public_key    Pointer to the buffer for the public key (OQS_SIG_perk_128_short_5_length_public_key bytes).
 * \param[out] secret_key    Pointer to the buffer for the secret key (OQS_SIG_perk_128_short_5_length_secret_key bytes).
 * \return OQS_SUCCESS or OQS_ERROR
 */
 ...
 *
 * \param[out] signature       Pointer to the buffer for the signature (OQS_SIG_perk_128_short_5_length_signature bytes).
 * \param[out] signature_len   Pointer to the length of the signature (always OQS_SIG_perk_128_short_5_length_signature).
 * \param[in]  message         Pointer to the message to be signed.
 * \param[in]  message_len     Length of the message to be signed.
 * \param[in]  secret_key      Pointer to the secret key (OQS_SIG_perk_128_short_5_length_secret_key bytes).
 * \return OQS_SUCCESS or OQS_ERROR
 */
 ...
 * \param[in]  message          Pointer to the message.
 * \param[in]  message_len      Length of the message.
 * \param[in]  signature        Pointer to the signature (OQS_SIG_perk_128_short_5_length_signature bytes).
 * \param[in]  signature_len    Length of the signature.
 * \param[in]  public_key       Pointer to the public key (OQS_SIG_perk_128_short_5_length_public_key bytes).
 * \return OQS_SUCCESS or OQS_ERROR
 */
...
/**
 * \brief PERK-128-short-5 signature verification with context string.
 *
 * \param[in]  message           Pointer to the message.
 * \param[in]  message_len       Length of the message.
 * \param[in]  signature         Pointer to the signature.
 ...
 * \warning The secret key contains the public key as a suffix.
 *
 * \param[out] public_key    Pointer to the buffer for the public key (OQS_SIG_perk_192_short_3_length_public_key bytes).
 * \param[out] secret_key    Pointer to the buffer for the secret key (OQS_SIG_perk_192_short_3_length_secret_key bytes).
 * \return OQS_SUCCESS or OQS_ERROR
 */
 ...
 *
 * \param[out] signature       Pointer to the buffer for the signature (OQS_SIG_perk_192_short_3_length_signature bytes).
 * \param[out] signature_len   Pointer to the length of the signature (always OQS_SIG_perk_192_short_3_length_signature).
 * \param[in]  message         Pointer to the message to be signed.
 * \param[in]  message_len     Length of the message to be signed.
 * \param[in]  secret_key      Pointer to the secret key (OQS_SIG_perk_192_short_3_length_secret_key bytes).
 * \return OQS_SUCCESS or OQS_ERROR
 */
 ...
 * \param[in]  message          Pointer to the message.
 * \param[in]  message_len      Length of the message.
 * \param[in]  signature        Pointer to the signature (OQS_SIG_perk_192_short_3_length_signature bytes).
 * \param[in]  signature_len    Length of the signature.
 * \param[in]  public_key       Pointer to the public key (OQS_SIG_perk_192_short_3_length_public_key bytes).
 * \return OQS_SUCCESS or OQS_ERROR
 */
...
/**
 * \brief PERK-192-short-3 signature verification with context string.
 *
 * \param[in]  message           Pointer to the message.
 * \param[in]  message_len       Length of the message.
 * \param[in]  signature         Pointer to the signature.
...
#define OQS_SIG_perk_192_short_5_length_public_key 368
 ...
 * \warning The secret key contains the public key as a suffix.
 *
 * \param[out] public_key    Pointer to the buffer for the public key (OQS_SIG_perk_192_short_5_length_public_key bytes).
 * \param[out] secret_key    Pointer to the buffer for the secret key (OQS_SIG_perk_192_short_5_length_secret_key bytes).
 * \return OQS_SUCCESS or OQS_ERROR
 */
 ...
 *
 * \param[out] signature       Pointer to the buffer for the signature (OQS_SIG_perk_192_short_5_length_signature bytes).
 * \param[out] signature_len   Pointer to the length of the signature (always OQS_SIG_perk_192_short_5_length_signature).
 * \param[in]  message         Pointer to the message to be signed.
 * \param[in]  message_len     Length of the message to be signed.
 * \param[in]  secret_key      Pointer to the secret key (OQS_SIG_perk_192_short_5_length_secret_key bytes).
 * \return OQS_SUCCESS or OQS_ERROR
 */
 ...
 * \param[in]  message          Pointer to the message.
 * \param[in]  message_len      Length of the message.
 * \param[in]  signature        Pointer to the signature (OQS_SIG_perk_192_short_5_length_signature bytes).
 * \param[in]  signature_len    Length of the signature.
 * \param[in]  public_key       Pointer to the public key (OQS_SIG_perk_192_short_5_length_public_key bytes).
 * \return OQS_SUCCESS or OQS_ERROR
 */
...
/**
 * \brief PERK-192-short-5 signature verification with context string.
 *
 * \param[in]  message           Pointer to the message.
 * \param[in]  message_len       Length of the message.
 * \param[in]  signature         Pointer to the signature.
...
#define OQS_SIG_perk_256_short_3_length_public_key 314

/** PERK-256-short-3 secret key length, in bytes */
#define OQS_SIG_perk_256_short_3_length_secret_key 346

/** PERK-256-short-3 signature length, in bytes */
#define OQS_SIG_perk_256_short_3_length_signature 25141

/**
 * \brief Process a PERK-256-short-3 key pair.
 * \warning The secret key contains the public key as a suffix.
 *
 * \param[out] public_key    Pointer to the buffer for the public key (OQS_SIG_perk_256_short_3_length_public_key bytes).
 * \param[out] secret_key    Pointer to the buffer for the secret key (OQS_SIG_perk_256_short_3_length_secret_key bytes).
 * \return OQS_SUCCESS or OQS_ERROR
 */
 ...
 *
 * \param[out] signature       Pointer to the buffer for the signature (OQS_SIG_perk_256_short_3_length_signature bytes).
 * \param[out] signature_len   Pointer to the length of the signature (always OQS_SIG_perk_256_short_3_length_signature).
 * \param[in]  message         Pointer to the message to be signed.
 * \param[in]  message_len     Length of the message to be signed.
 * \param[in]  secret_key      Pointer to the secret key (OQS_SIG_perk_256_short_3_length_secret_key bytes).
 * \return OQS_SUCCESS or OQS_ERROR
 */
 ...
 * \param[in]  message          Pointer to the message.
 * \param[in]  message_len      Length of the message.
 * \param[in]  signature        Pointer to the signature (OQS_SIG_perk_256_short_3_length_signature bytes).
 * \param[in]  signature_len    Length of the signature.
 * \param[in]  public_key       Pointer to the public key (OQS_SIG_perk_256_short_3_length_public_key bytes).
 * \return OQS_SUCCESS or OQS_ERROR
 */
...
/** PERK-256-short-5 secret key length, in bytes */
#define OQS_SIG_perk_256_short_5_length_secret_key 539

/** PERK-256-short-5 signature length, in bytes */
 ...
 * \warning The secret key contains the public key as a suffix.
 *
 * \param[out] public_key    Pointer to the buffer for the public key (OQS_SIG_perk_256_short_5_length_public_key bytes).
 * \param[out] secret_key    Pointer to the buffer for the secret key (OQS_SIG_perk_256_short_5_length_secret_key bytes).
 * \return OQS_SUCCESS or OQS_ERROR
 */
 ...
 *
 * \param[out] signature       Pointer to the buffer for the signature (OQS_SIG_perk_256_short_5_length_signature bytes).
 * \param[out] signature_len   Pointer to the length of the signature (always OQS_SIG_perk_256_short_5_length_signature).
 * \param[in]  message         Pointer to the message to be signed.
 * \param[in]  message_len     Length of the message to be signed.
 * \param[in]  secret_key      Pointer to the secret key (OQS_SIG_perk_256_short_5_length_secret_key bytes).
 * \return OQS_SUCCESS or OQS_ERROR
 */
 ...
 * \param[in]  message          Pointer to the message.
 * \param[in]  message_len      Length of the message.
 * \param[in]  signature        Pointer to the signature (OQS_SIG_perk_256_short_5_length_signature bytes).
 * \param[in]  signature_len    Length of the signature.
 * \param[in]  public_key       Pointer to the public key (OQS_SIG_perk_256_short_5_length_public_key bytes).
 * \return OQS_SUCCESS or OQS_ERROR
 */
...
/**
 * \brief PERK-256-short-5 signature generation with context string.
 *
 * \param[out] signature         Pointer to the output signature buffer.
 * \param[out] signature_len     Pointer to the length of the signature.
 * \param[in]  message           Pointer to the message to be signed.
