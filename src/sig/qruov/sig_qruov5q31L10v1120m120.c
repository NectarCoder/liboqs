...
OQS_SIG *OQS_SIG_qruov5q31L10v1120m120_new(void) {
	...
	sig->method_name = OQS_SIG_alg_qruov5q31L10v1120m120;
	sig->alg_version = "refa";

	sig->claimed_nist_level = 5;
	sig->euf_cma = true;
	sig->sig_with_ctx_support = false;

	sig->length_public_key = OQS_SIG_qruov5q31L10v1120m120_length_public_key;
	sig->length_secret_key = OQS_SIG_qruov5q31L10v1120m120_length_secret_key;
	sig->length_signature = OQS_SIG_qruov5q31L10v1120m120_length_signature;

	sig->keypair = (OQS_STATUS (*)(uint8_t *, uint8_t *)) OQS_SIG_qruov5q31L10v1120m120_keypair;
	sig->sign = (OQS_STATUS (*)(uint8_t *, size_t *, const uint8_t *, size_t, const uint8_t *)) OQS_SIG_qruov5q31L10v1120m120_sign;
	sig->verify = (OQS_STATUS (*)(const uint8_t *, size_t, const uint8_t *, size_t, const uint8_t *)) OQS_SIG_qruov5q31L10v1120m120_verify;
	sig->sign_with_ctx_str = (OQS_STATUS (*)(uint8_t *, size_t *, const uint8_t *, size_t, const uint8_t *, size_t, const uint8_t *)) OQS_SIG_qruov5q31L10v1120m120_sign_with_ctx_str;
	sig->verify_with_ctx_str = (OQS_STATUS (*)(const uint8_t *, size_t, const uint8_t *, size_t, const uint8_t *, size_t, const uint8_t *)) OQS_SIG_qruov5q31L10v1120m120_verify_with_ctx_str;
...
OQS_API OQS_STATUS OQS_SIG_qruov5q31L10v1120m120_keypair(uint8_t *public_key, uint8_t *secret_key) {
	...
	if (crypto_sign_keypair(public_key, secret_key) != 0) {
		memset(public_key, 0, OQS_SIG_qruov5q31L10v1120m120_length_public_key);
		memset(secret_key, 0, OQS_SIG_qruov5q31L10v1120m120_length_secret_key);
		return OQS_ERROR;
	}
...
OQS_API OQS_STATUS OQS_SIG_qruov5q31L10v1120m120_sign(uint8_t *signature, size_t *signature_len, const uint8_t *message, size_t message_len, const uint8_t *secret_key) {
	...
	*signature_len = 0;
	...
	if (message_len > SIZE_MAX - CRYPTO_BYTES) {
		memset(signature, 0, OQS_SIG_qruov5q31L10v1120m120_length_signature);
		return OQS_ERROR;
	}
	...
	int rc = crypto_sign(signed_message, &produced_len, message, (unsigned long long) message_len, secret_key);
	if (rc != 0 || produced_len != (unsigned long long) signed_message_len) {
...
OQS_API OQS_STATUS OQS_SIG_qruov5q31L10v1120m120_verify(const uint8_t *message, size_t message_len, const uint8_t *signature, size_t signature_len, const uint8_t *public_key) {
	...
	int rc = crypto_sign_open(recovered_message, &recovered_len, signed_message, (unsigned long long) signed_message_len, public_key);
	if (rc != 0 || recovered_len != (unsigned long long) message_len || (message_len > 0 && memcmp(recovered_message, message, message_len) != 0)) {
		OQS_MEM_insecure_free(signed_message);
		OQS_MEM_insecure_free(recovered_message);
		return OQS_ERROR;
	}
...
OQS_API OQS_STATUS OQS_SIG_qruov5q31L10v1120m120_sign_with_ctx_str(uint8_t *signature, size_t *signature_len, const uint8_t *message, size_t message_len, const uint8_t *ctx_str, size_t ctx_str_len, const uint8_t *secret_key) {
	...
	return OQS_SIG_qruov5q31L10v1120m120_sign(signature, signature_len, message, message_len, secret_key);
}
...
OQS_API OQS_STATUS OQS_SIG_qruov5q31L10v1120m120_verify_with_ctx_str(const uint8_t *message, size_t message_len, const uint8_t *signature, size_t signature_len, const uint8_t *ctx_str, size_t ctx_str_len, const uint8_t *public_key) {
	...
	return OQS_SIG_qruov5q31L10v1120m120_verify(message, message_len, signature, signature_len, public_key);
}
