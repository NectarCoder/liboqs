...
// Namespacing field constants shared across translation units:
#undef ONE
#undef ZERO
...
// Namespacing precomputation data shared across translation units:
...
#define DRBG_ctx                                         SQISIGN_NAMESPACE(DRBG_ctx)
