...
{
    return sqisign_lvl5_ref_sqisign_keypair(pk, sk);
}
...
crypto_sign(unsigned char *sm, unsigned long long *smlen,
            ...
            const unsigned char *sk)
{
    return sqisign_lvl5_ref_sqisign_sign(sm, smlen, m, mlen, sk);
}
#endif
...
crypto_sign_open(unsigned char *m, unsigned long long *mlen,
                 ...
                 const unsigned char *pk)
{
    return sqisign_lvl5_ref_sqisign_open(m, mlen, sm, smlen, pk);
}
