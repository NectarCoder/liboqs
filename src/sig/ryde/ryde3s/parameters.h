...
#define RYDE_SIGNATURE_BYTES 7064        /**< Signature size */
...
#define RYDE_PARAM_TAU 19                /**< Parameter tau of the scheme (number of iterations) */
#define RYDE_PARAM_TAU_1 19              /**< Parameter tau_1 of the scheme (number of iterations concerning N1) */
...
#define RYDE_PARAM_TREE_LEAVES 38912     /**< Number of leaves in the tree */

#define RYDE_PARAM_CHALLENGE_1_BYTES 305 /**< Number of bytes required to store the first challenge */
#define RYDE_PARAM_CHALLENGE_2_BYTES 27  /**< Number of bytes required to store the second challenge */
...
#define RYDE_PARAM_T_OPEN 176            /**< Maximum sibling path length allowed */
