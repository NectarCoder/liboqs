...
/** mirath_tcith_3b_short public key length in bytes */
#define OQS_SIG_mirath_tcith_3b_short_length_public_key 84

/** mirath_tcith_3b_short secret key length in bytes */
#define OQS_SIG_mirath_tcith_3b_short_length_secret_key 48

/** mirath_tcith_3b_short signature length in bytes */
#define OQS_SIG_mirath_tcith_3b_short_length_signature 6825
...
#endif /* OQS_ENABLE_SIG_mirath_tcith_3b_short */
...
/** mirath_tcith_5a_short public key length in bytes */
#define OQS_SIG_mirath_tcith_5a_short_length_public_key 147

/** mirath_tcith_5a_short secret key length in bytes */
#define OQS_SIG_mirath_tcith_5a_short_length_secret_key 64

/** mirath_tcith_5a_short signature length in bytes */
...
#define OQS_SIG_alg_mirath_tcith_1b_short "MIRATH-TCITH-1B-SHORT"

/** mirath_tcith_1b_short public key length in bytes */
...
/** mirath_tcith_1b_short signature length in bytes */
...
#endif /* OQS_ENABLE_SIG_mirath_tcith_1b_short */

#if defined(OQS_ENABLE_SIG_mirath_tcith_3a_short)

/** Algorithm identifier for mirath_tcith_3a_short */
#define OQS_SIG_alg_mirath_tcith_3a_short "MIRATH-TCITH-3A-SHORT"

/** mirath_tcith_3a_short public key length in bytes */
#define OQS_SIG_mirath_tcith_3a_short_length_public_key 107

/** mirath_tcith_3a_short secret key length in bytes */
#define OQS_SIG_mirath_tcith_3a_short_length_secret_key 48

/** mirath_tcith_3a_short signature length in bytes */
...
#endif /* OQS_ENABLE_SIG_mirath_tcith_3a_short */
