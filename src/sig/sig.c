...
OQS_API const char *OQS_SIG_alg_identifier(size_t i) {
	...
	const char *a[OQS_SIG_algs_length] = {
		...
		OQS_SIG_alg_sdith_cat3_short,
		OQS_SIG_alg_sdith_cat5_short,
		OQS_SIG_alg_mirath_tcith_1a_short,
		OQS_SIG_alg_mirath_tcith_1b_short,
		OQS_SIG_alg_mirath_tcith_3a_short,
		OQS_SIG_alg_mirath_tcith_3b_short,
		OQS_SIG_alg_mirath_tcith_5a_short,
		OQS_SIG_alg_mirath_tcith_5b_short,
		OQS_SIG_alg_mqom2_cat1_gf2_short_r3,
		OQS_SIG_alg_mqom2_cat1_gf2_short_r5,
		OQS_SIG_alg_mqom2_cat1_gf16_short_r3,
		OQS_SIG_alg_mqom2_cat1_gf16_short_r5,
		OQS_SIG_alg_mqom2_cat1_gf256_short_r3,
		OQS_SIG_alg_mqom2_cat1_gf256_short_r5,
		OQS_SIG_alg_mqom2_cat3_gf2_short_r3,
		OQS_SIG_alg_mqom2_cat3_gf2_short_r5,
		OQS_SIG_alg_mqom2_cat3_gf16_short_r3,
		OQS_SIG_alg_mqom2_cat3_gf16_short_r5,
		OQS_SIG_alg_mqom2_cat3_gf256_short_r3,
		OQS_SIG_alg_mqom2_cat3_gf256_short_r5,
		OQS_SIG_alg_mqom2_cat5_gf2_short_r3,
		OQS_SIG_alg_mqom2_cat5_gf2_short_r5,
		OQS_SIG_alg_mqom2_cat5_gf16_short_r3,
		...
		OQS_SIG_alg_qruov1q127L3v156m54,
		OQS_SIG_alg_qruov1q7L10v740m100,
		OQS_SIG_alg_qruov1q31L3v165m60,
		OQS_SIG_alg_qruov1q31L10v600m70,
		OQS_SIG_alg_qruov3q127L3v228m78,
		OQS_SIG_alg_qruov3q7L10v1100m140,
		OQS_SIG_alg_qruov3q31L3v246m87,
		OQS_SIG_alg_qruov3q31L10v890m100,
		OQS_SIG_alg_qruov5q127L3v306m105,
		OQS_SIG_alg_qruov5q7L10v1490m190,
		OQS_SIG_alg_qruov5q31L3v324m114,
		OQS_SIG_alg_qruov5q31L10v1120m120,
		OQS_SIG_alg_sqisign_353,
		OQS_SIG_alg_sqisign_529,
		OQS_SIG_alg_sqisign_701,
...
OQS_API int OQS_SIG_alg_is_enabled(const char *method_name) {
	...
	} else if (0 == strcasecmp(method_name, OQS_SIG_alg_faest_192s)) {
	...
	} else if (0 == strcasecmp(method_name, OQS_SIG_alg_faest_em_192s)) {
#ifdef OQS_ENABLE_SIG_faest_em_192s
		return 1;
#else
		return 0;
#endif
	...
	} else if (0 == strcasecmp(method_name, OQS_SIG_alg_sdith_cat3_short)) {
#ifdef OQS_ENABLE_SIG_sdith_cat3_short
		return 1;
#else
		return 0;
#endif

	} else if (0 == strcasecmp(method_name, OQS_SIG_alg_sdith_cat5_short)) {
#ifdef OQS_ENABLE_SIG_sdith_cat5_short
		return 1;
#else
		return 0;
#endif
	...
	} else if (0 == strcasecmp(method_name, OQS_SIG_alg_mirath_tcith_1b_short)) {
#ifdef OQS_ENABLE_SIG_mirath_tcith_1b_short
		return 1;
#else
		return 0;
#endif
	...
	} else if (0 == strcasecmp(method_name, OQS_SIG_alg_mirath_tcith_3b_short)) {
#ifdef OQS_ENABLE_SIG_mirath_tcith_3b_short
		return 1;
#else
		return 0;
#endif

	} else if (0 == strcasecmp(method_name, OQS_SIG_alg_mirath_tcith_5a_short)) {
#ifdef OQS_ENABLE_SIG_mirath_tcith_5a_short
		return 1;
#else
		return 0;
#endif
	...
	} else if (0 == strcasecmp(method_name, OQS_SIG_alg_mqom2_cat1_gf2_short_r3)) {
#ifdef OQS_ENABLE_SIG_mqom2_cat1_gf2_short_r3
		return 1;
#else
		return 0;
#endif

	} else if (0 == strcasecmp(method_name, OQS_SIG_alg_mqom2_cat1_gf2_short_r5)) {
#ifdef OQS_ENABLE_SIG_mqom2_cat1_gf2_short_r5
		return 1;
#else
		return 0;
#endif

	} else if (0 == strcasecmp(method_name, OQS_SIG_alg_mqom2_cat1_gf16_short_r3)) {
#ifdef OQS_ENABLE_SIG_mqom2_cat1_gf16_short_r3
		return 1;
#else
		return 0;
#endif

	} else if (0 == strcasecmp(method_name, OQS_SIG_alg_mqom2_cat1_gf16_short_r5)) {
#ifdef OQS_ENABLE_SIG_mqom2_cat1_gf16_short_r5
		return 1;
#else
		return 0;
#endif

	} else if (0 == strcasecmp(method_name, OQS_SIG_alg_mqom2_cat1_gf256_short_r3)) {
#ifdef OQS_ENABLE_SIG_mqom2_cat1_gf256_short_r3
		return 1;
#else
		return 0;
#endif

	} else if (0 == strcasecmp(method_name, OQS_SIG_alg_mqom2_cat1_gf256_short_r5)) {
#ifdef OQS_ENABLE_SIG_mqom2_cat1_gf256_short_r5
		return 1;
#else
		return 0;
#endif

	} else if (0 == strcasecmp(method_name, OQS_SIG_alg_mqom2_cat3_gf2_short_r3)) {
#ifdef OQS_ENABLE_SIG_mqom2_cat3_gf2_short_r3
		return 1;
#else
		return 0;
#endif

	} else if (0 == strcasecmp(method_name, OQS_SIG_alg_mqom2_cat3_gf2_short_r5)) {
#ifdef OQS_ENABLE_SIG_mqom2_cat3_gf2_short_r5
		return 1;
#else
		return 0;
#endif

	} else if (0 == strcasecmp(method_name, OQS_SIG_alg_mqom2_cat3_gf16_short_r3)) {
#ifdef OQS_ENABLE_SIG_mqom2_cat3_gf16_short_r3
		return 1;
#else
		return 0;
#endif

	} else if (0 == strcasecmp(method_name, OQS_SIG_alg_mqom2_cat3_gf16_short_r5)) {
#ifdef OQS_ENABLE_SIG_mqom2_cat3_gf16_short_r5
		return 1;
#else
		return 0;
#endif

	} else if (0 == strcasecmp(method_name, OQS_SIG_alg_mqom2_cat3_gf256_short_r3)) {
#ifdef OQS_ENABLE_SIG_mqom2_cat3_gf256_short_r3
		return 1;
#else
		return 0;
#endif

	} else if (0 == strcasecmp(method_name, OQS_SIG_alg_mqom2_cat3_gf256_short_r5)) {
#ifdef OQS_ENABLE_SIG_mqom2_cat3_gf256_short_r5
		return 1;
#else
		return 0;
#endif

	} else if (0 == strcasecmp(method_name, OQS_SIG_alg_mqom2_cat5_gf2_short_r3)) {
#ifdef OQS_ENABLE_SIG_mqom2_cat5_gf2_short_r3
		return 1;
#else
		return 0;
#endif

	} else if (0 == strcasecmp(method_name, OQS_SIG_alg_mqom2_cat5_gf2_short_r5)) {
#ifdef OQS_ENABLE_SIG_mqom2_cat5_gf2_short_r5
		return 1;
#else
		return 0;
#endif

	} else if (0 == strcasecmp(method_name, OQS_SIG_alg_mqom2_cat5_gf16_short_r3)) {
#ifdef OQS_ENABLE_SIG_mqom2_cat5_gf16_short_r3
		return 1;
#else
		return 0;
#endif

	} else if (0 == strcasecmp(method_name, OQS_SIG_alg_mqom2_cat5_gf16_short_r5)) {
#ifdef OQS_ENABLE_SIG_mqom2_cat5_gf16_short_r5
		return 1;
#else
		return 0;
#endif

	} else if (0 == strcasecmp(method_name, OQS_SIG_alg_mqom2_cat5_gf256_short_r3)) {
#ifdef OQS_ENABLE_SIG_mqom2_cat5_gf256_short_r3
		return 1;
#else
		return 0;
#endif
	...
	} else if (0 == strcasecmp(method_name, OQS_SIG_alg_qruov1q127L3v156m54)) {
#ifdef OQS_ENABLE_SIG_qruov1q127L3v156m54
		return 1;
#else
		return 0;
#endif

	} else if (0 == strcasecmp(method_name, OQS_SIG_alg_qruov1q7L10v740m100)) {
	...
	} else if (0 == strcasecmp(method_name, OQS_SIG_alg_qruov1q31L3v165m60)) {
#ifdef OQS_ENABLE_SIG_qruov1q31L3v165m60
		return 1;
#else
		return 0;
#endif

	} else if (0 == strcasecmp(method_name, OQS_SIG_alg_qruov1q31L10v600m70)) {
#ifdef OQS_ENABLE_SIG_qruov1q31L10v600m70
		return 1;
#else
		return 0;
#endif

	} else if (0 == strcasecmp(method_name, OQS_SIG_alg_qruov3q127L3v228m78)) {
#ifdef OQS_ENABLE_SIG_qruov3q127L3v228m78
		return 1;
#else
		return 0;
#endif

	} else if (0 == strcasecmp(method_name, OQS_SIG_alg_qruov3q7L10v1100m140)) {
	...
	} else if (0 == strcasecmp(method_name, OQS_SIG_alg_qruov3q31L3v246m87)) {
#ifdef OQS_ENABLE_SIG_qruov3q31L3v246m87
		return 1;
#else
		return 0;
#endif

	} else if (0 == strcasecmp(method_name, OQS_SIG_alg_qruov3q31L10v890m100)) {
#ifdef OQS_ENABLE_SIG_qruov3q31L10v890m100
		return 1;
#else
		return 0;
#endif

	} else if (0 == strcasecmp(method_name, OQS_SIG_alg_qruov5q127L3v306m105)) {
#ifdef OQS_ENABLE_SIG_qruov5q127L3v306m105
		return 1;
#else
		return 0;
#endif

	} else if (0 == strcasecmp(method_name, OQS_SIG_alg_qruov5q7L10v1490m190)) {
	...
	} else if (0 == strcasecmp(method_name, OQS_SIG_alg_qruov5q31L3v324m114)) {
#ifdef OQS_ENABLE_SIG_qruov5q31L3v324m114
		return 1;
#else
		return 0;
#endif

	} else if (0 == strcasecmp(method_name, OQS_SIG_alg_qruov5q31L10v1120m120)) {
#ifdef OQS_ENABLE_SIG_qruov5q31L10v1120m120
		return 1;
#else
		return 0;
#endif

	} else if (0 == strcasecmp(method_name, OQS_SIG_alg_sqisign_353)) {
#ifdef OQS_ENABLE_SIG_sqisign_353
		return 1;
#else
		return 0;
#endif

	} else if (0 == strcasecmp(method_name, OQS_SIG_alg_sqisign_529)) {
#ifdef OQS_ENABLE_SIG_sqisign_529
		return 1;
#else
		return 0;
#endif

	} else if (0 == strcasecmp(method_name, OQS_SIG_alg_sqisign_701)) {
#ifdef OQS_ENABLE_SIG_sqisign_701
		return 1;
#else
		return 0;
#endif
...
#ifdef OQS_ENABLE_SIG_faest_em_192s
		return OQS_SIG_faest_em_192s_new();
#else
		return NULL;
#endif
...
#ifdef OQS_ENABLE_SIG_mirath_tcith_1a_short
		return OQS_SIG_mirath_tcith_1a_short_new();
#else
		return NULL;
#endif
...
#ifdef OQS_ENABLE_SIG_mirath_tcith_1b_short
		return OQS_SIG_mirath_tcith_1b_short_new();
#else
		return NULL;
#endif
...
#ifdef OQS_ENABLE_SIG_mirath_tcith_3a_short
		return OQS_SIG_mirath_tcith_3a_short_new();
#else
		return NULL;
#endif
...
#ifdef OQS_ENABLE_SIG_mirath_tcith_3b_short
		return OQS_SIG_mirath_tcith_3b_short_new();
#else
		return NULL;
#endif
...
#ifdef OQS_ENABLE_SIG_mirath_tcith_5a_short
		return OQS_SIG_mirath_tcith_5a_short_new();
#else
		return NULL;
#endif
...
#ifdef OQS_ENABLE_SIG_sdith_cat3_short
		return OQS_SIG_sdith_cat3_short_new();
#else
		return NULL;
#endif
...
#ifdef OQS_ENABLE_SIG_sdith_cat5_short
		return OQS_SIG_sdith_cat5_short_new();
#else
		return NULL;
#endif
...
#ifdef OQS_ENABLE_SIG_mqom2_cat1_gf2_short_r3
		return OQS_SIG_mqom2_cat1_gf2_short_r3_new();
#else
		return NULL;
#endif
...
#ifdef OQS_ENABLE_SIG_mqom2_cat1_gf2_short_r5
		return OQS_SIG_mqom2_cat1_gf2_short_r5_new();
#else
		return NULL;
#endif
...
#ifdef OQS_ENABLE_SIG_mqom2_cat1_gf16_short_r3
		return OQS_SIG_mqom2_cat1_gf16_short_r3_new();
#else
		return NULL;
#endif
...
#ifdef OQS_ENABLE_SIG_mqom2_cat1_gf16_short_r5
		return OQS_SIG_mqom2_cat1_gf16_short_r5_new();
#else
		return NULL;
#endif
...
#ifdef OQS_ENABLE_SIG_mqom2_cat1_gf256_short_r3
		return OQS_SIG_mqom2_cat1_gf256_short_r3_new();
#else
		return NULL;
#endif
...
#ifdef OQS_ENABLE_SIG_mqom2_cat1_gf256_short_r5
		return OQS_SIG_mqom2_cat1_gf256_short_r5_new();
#else
		return NULL;
#endif
...
#ifdef OQS_ENABLE_SIG_mqom2_cat3_gf2_short_r3
		return OQS_SIG_mqom2_cat3_gf2_short_r3_new();
#else
		return NULL;
#endif
...
#ifdef OQS_ENABLE_SIG_mqom2_cat3_gf2_short_r5
		return OQS_SIG_mqom2_cat3_gf2_short_r5_new();
#else
		return NULL;
#endif
...
#ifdef OQS_ENABLE_SIG_mqom2_cat3_gf16_short_r3
		return OQS_SIG_mqom2_cat3_gf16_short_r3_new();
#else
		return NULL;
#endif
...
#ifdef OQS_ENABLE_SIG_mqom2_cat3_gf16_short_r5
		return OQS_SIG_mqom2_cat3_gf16_short_r5_new();
#else
		return NULL;
#endif
...
#ifdef OQS_ENABLE_SIG_mqom2_cat3_gf256_short_r3
		return OQS_SIG_mqom2_cat3_gf256_short_r3_new();
#else
		return NULL;
#endif
...
#ifdef OQS_ENABLE_SIG_mqom2_cat3_gf256_short_r5
		return OQS_SIG_mqom2_cat3_gf256_short_r5_new();
#else
		return NULL;
#endif
...
#ifdef OQS_ENABLE_SIG_mqom2_cat5_gf2_short_r3
		return OQS_SIG_mqom2_cat5_gf2_short_r3_new();
#else
		return NULL;
#endif
...
#ifdef OQS_ENABLE_SIG_mqom2_cat5_gf2_short_r5
		return OQS_SIG_mqom2_cat5_gf2_short_r5_new();
#else
		return NULL;
#endif
...
#ifdef OQS_ENABLE_SIG_mqom2_cat5_gf16_short_r3
		return OQS_SIG_mqom2_cat5_gf16_short_r3_new();
#else
		return NULL;
#endif
...
#ifdef OQS_ENABLE_SIG_mqom2_cat5_gf16_short_r5
		return OQS_SIG_mqom2_cat5_gf16_short_r5_new();
#else
		return NULL;
#endif
...
#ifdef OQS_ENABLE_SIG_mqom2_cat5_gf256_short_r3
		return OQS_SIG_mqom2_cat5_gf256_short_r3_new();
#else
		return NULL;
#endif
...
#ifdef OQS_ENABLE_SIG_mqom2_cat5_gf256_short_r5
		return OQS_SIG_mqom2_cat5_gf256_short_r5_new();
#else
		return NULL;
#endif
...
#ifdef OQS_ENABLE_SIG_qruov1q127L3v156m54
		return OQS_SIG_qruov1q127L3v156m54_new();
#else
		return NULL;
#endif
...
#ifdef OQS_ENABLE_SIG_qruov1q7L10v740m100
		return OQS_SIG_qruov1q7L10v740m100_new();
#else
		return NULL;
#endif
...
#ifdef OQS_ENABLE_SIG_qruov1q31L3v165m60
		return OQS_SIG_qruov1q31L3v165m60_new();
#else
		return NULL;
#endif
...
#ifdef OQS_ENABLE_SIG_qruov1q31L10v600m70
		return OQS_SIG_qruov1q31L10v600m70_new();
#else
		return NULL;
#endif
...
#ifdef OQS_ENABLE_SIG_qruov3q127L3v228m78
		return OQS_SIG_qruov3q127L3v228m78_new();
#else
		return NULL;
#endif
...
#ifdef OQS_ENABLE_SIG_qruov3q7L10v1100m140
		return OQS_SIG_qruov3q7L10v1100m140_new();
#else
		return NULL;
#endif
...
#ifdef OQS_ENABLE_SIG_qruov3q31L3v246m87
		return OQS_SIG_qruov3q31L3v246m87_new();
#else
		return NULL;
#endif
...
#ifdef OQS_ENABLE_SIG_qruov3q31L10v890m100
		return OQS_SIG_qruov3q31L10v890m100_new();
#else
		return NULL;
#endif
...
#ifdef OQS_ENABLE_SIG_qruov5q127L3v306m105
		return OQS_SIG_qruov5q127L3v306m105_new();
#else
		return NULL;
#endif
...
#ifdef OQS_ENABLE_SIG_qruov5q7L10v1490m190
		return OQS_SIG_qruov5q7L10v1490m190_new();
#else
		return NULL;
#endif
...
#ifdef OQS_ENABLE_SIG_qruov5q31L3v324m114
		return OQS_SIG_qruov5q31L3v324m114_new();
#else
		return NULL;
#endif
...
#ifdef OQS_ENABLE_SIG_qruov5q31L10v1120m120
		return OQS_SIG_qruov5q31L10v1120m120_new();
#else
		return NULL;
#endif
...
#ifdef OQS_ENABLE_SIG_sqisign_353
		return OQS_SIG_sqisign_353_new();
#else
		return NULL;
#endif
...
#ifdef OQS_ENABLE_SIG_sqisign_529
		return OQS_SIG_sqisign_529_new();
#else
		return NULL;
#endif
...
#ifdef OQS_ENABLE_SIG_sqisign_701
		return OQS_SIG_sqisign_701_new();
#else
		return NULL;
#endif
