...
OQS_STATUS combine_message_signature(uint8_t **signed_msg, size_t *signed_msg_len, const uint8_t *msg, size_t msg_len, const uint8_t *signature, size_t signature_len, const OQS_SIG *sig) {
	if (0) {
		...
		*signed_msg = OQS_MEM_malloc(*signed_msg_len);
		...
		memcpy(*signed_msg + signature_len, msg, msg_len);
		return OQS_SUCCESS;
	} else if (0 == strcmp(sig->method_name, "MQOM2-CAT1-GF2-SHORT-R3")) {
		// signed_msg = signature || msg
		*signed_msg_len = signature_len + msg_len;
		*signed_msg = OQS_MEM_malloc(*signed_msg_len);
		if (*signed_msg == NULL) {
		...
		memcpy(*signed_msg + signature_len, msg, msg_len);
		return OQS_SUCCESS;
	} else if (0 == strcmp(sig->method_name, "MQOM2-CAT1-GF2-SHORT-R5")) {
		// signed_msg = signature || msg
		*signed_msg_len = signature_len + msg_len;
		*signed_msg = OQS_MEM_malloc(*signed_msg_len);
		if (*signed_msg == NULL) {
		...
		memcpy(*signed_msg + signature_len, msg, msg_len);
		return OQS_SUCCESS;
	} else if (0 == strcmp(sig->method_name, "MQOM2-CAT1-GF16-SHORT-R3")) {
		// signed_msg = signature || msg
		*signed_msg_len = signature_len + msg_len;
		*signed_msg = OQS_MEM_malloc(*signed_msg_len);
		if (*signed_msg == NULL) {
		...
		memcpy(*signed_msg + signature_len, msg, msg_len);
		return OQS_SUCCESS;
	} else if (0 == strcmp(sig->method_name, "MQOM2-CAT1-GF16-SHORT-R5")) {
		// signed_msg = signature || msg
		*signed_msg_len = signature_len + msg_len;
		*signed_msg = OQS_MEM_malloc(*signed_msg_len);
		if (*signed_msg == NULL) {
		...
		memcpy(*signed_msg + signature_len, msg, msg_len);
		return OQS_SUCCESS;
	} else if (0 == strcmp(sig->method_name, "MQOM2-CAT1-GF256-SHORT-R3")) {
		// signed_msg = signature || msg
		*signed_msg_len = signature_len + msg_len;
		*signed_msg = OQS_MEM_malloc(*signed_msg_len);
		if (*signed_msg == NULL) {
		...
		memcpy(*signed_msg + signature_len, msg, msg_len);
		return OQS_SUCCESS;
	} else if (0 == strcmp(sig->method_name, "MQOM2-CAT1-GF256-SHORT-R5")) {
		// signed_msg = signature || msg
		*signed_msg_len = signature_len + msg_len;
		*signed_msg = OQS_MEM_malloc(*signed_msg_len);
		if (*signed_msg == NULL) {
		...
		memcpy(*signed_msg + signature_len, msg, msg_len);
		return OQS_SUCCESS;
	} else if (0 == strcmp(sig->method_name, "MQOM2-CAT3-GF2-SHORT-R3")) {
		// signed_msg = signature || msg
		*signed_msg_len = signature_len + msg_len;
		*signed_msg = OQS_MEM_malloc(*signed_msg_len);
		if (*signed_msg == NULL) {
		...
		memcpy(*signed_msg + signature_len, msg, msg_len);
		return OQS_SUCCESS;
	} else if (0 == strcmp(sig->method_name, "MQOM2-CAT3-GF2-SHORT-R5")) {
		// signed_msg = signature || msg
		*signed_msg_len = signature_len + msg_len;
		*signed_msg = OQS_MEM_malloc(*signed_msg_len);
		if (*signed_msg == NULL) {
		...
		memcpy(*signed_msg + signature_len, msg, msg_len);
		return OQS_SUCCESS;
	} else if (0 == strcmp(sig->method_name, "MQOM2-CAT3-GF16-SHORT-R3")) {
		// signed_msg = signature || msg
		*signed_msg_len = signature_len + msg_len;
		*signed_msg = OQS_MEM_malloc(*signed_msg_len);
		if (*signed_msg == NULL) {
		...
		memcpy(*signed_msg + signature_len, msg, msg_len);
		return OQS_SUCCESS;
	} else if (0 == strcmp(sig->method_name, "MQOM2-CAT3-GF16-SHORT-R5")) {
		// signed_msg = signature || msg
		*signed_msg_len = signature_len + msg_len;
		*signed_msg = OQS_MEM_malloc(*signed_msg_len);
		if (*signed_msg == NULL) {
		...
		memcpy(*signed_msg + signature_len, msg, msg_len);
		return OQS_SUCCESS;
	} else if (0 == strcmp(sig->method_name, "MQOM2-CAT3-GF256-SHORT-R3")) {
		// signed_msg = signature || msg
		*signed_msg_len = signature_len + msg_len;
		*signed_msg = OQS_MEM_malloc(*signed_msg_len);
		if (*signed_msg == NULL) {
		...
		memcpy(*signed_msg + signature_len, msg, msg_len);
		return OQS_SUCCESS;
	} else if (0 == strcmp(sig->method_name, "MQOM2-CAT3-GF256-SHORT-R5")) {
		// signed_msg = signature || msg
		*signed_msg_len = signature_len + msg_len;
		*signed_msg = OQS_MEM_malloc(*signed_msg_len);
		if (*signed_msg == NULL) {
		...
		memcpy(*signed_msg + signature_len, msg, msg_len);
		return OQS_SUCCESS;
	} else if (0 == strcmp(sig->method_name, "MQOM2-CAT5-GF2-SHORT-R3")) {
		// signed_msg = signature || msg
		*signed_msg_len = signature_len + msg_len;
		*signed_msg = OQS_MEM_malloc(*signed_msg_len);
		if (*signed_msg == NULL) {
		...
		memcpy(*signed_msg + signature_len, msg, msg_len);
		return OQS_SUCCESS;
	} else if (0 == strcmp(sig->method_name, "MQOM2-CAT5-GF2-SHORT-R5")) {
		// signed_msg = signature || msg
		*signed_msg_len = signature_len + msg_len;
		*signed_msg = OQS_MEM_malloc(*signed_msg_len);
		if (*signed_msg == NULL) {
		...
		memcpy(*signed_msg + signature_len, msg, msg_len);
		return OQS_SUCCESS;
	} else if (0 == strcmp(sig->method_name, "MQOM2-CAT5-GF16-SHORT-R3")) {
		// signed_msg = signature || msg
		*signed_msg_len = signature_len + msg_len;
		*signed_msg = OQS_MEM_malloc(*signed_msg_len);
		if (*signed_msg == NULL) {
		...
		memcpy(*signed_msg + signature_len, msg, msg_len);
		return OQS_SUCCESS;
	} else if (0 == strcmp(sig->method_name, "MQOM2-CAT5-GF16-SHORT-R5")) {
		// signed_msg = signature || msg
		*signed_msg_len = signature_len + msg_len;
		*signed_msg = OQS_MEM_malloc(*signed_msg_len);
		if (*signed_msg == NULL) {
		...
		memcpy(*signed_msg + signature_len, msg, msg_len);
		return OQS_SUCCESS;
	} else if (0 == strcmp(sig->method_name, "MQOM2-CAT5-GF256-SHORT-R3")) {
		// signed_msg = signature || msg
		*signed_msg_len = signature_len + msg_len;
		*signed_msg = OQS_MEM_malloc(*signed_msg_len);
		if (*signed_msg == NULL) {
		...
		memcpy(*signed_msg + signature_len, msg, msg_len);
		return OQS_SUCCESS;
	} else if (0 == strcmp(sig->method_name, "MQOM2-CAT5-GF256-SHORT-R5")) {
		// signed_msg = signature || msg
		*signed_msg_len = signature_len + msg_len;
		*signed_msg = OQS_MEM_malloc(*signed_msg_len);
		if (*signed_msg == NULL) {
		...
		*signed_msg = OQS_MEM_malloc(*signed_msg_len);
		...
		memcpy(*signed_msg + signature_len, msg, msg_len);
		return OQS_SUCCESS;
	} else if (0 == strcmp(sig->method_name, "MIRATH-TCITH-1A-SHORT") || 0 == strcmp(sig->method_name, "MIRATH-TCITH-1B-SHORT") || 0 == strcmp(sig->method_name, "MIRATH-TCITH-3A-SHORT") || 0 == strcmp(sig->method_name, "MIRATH-TCITH-3B-SHORT") || 0 == strcmp(sig->method_name, "MIRATH-TCITH-5A-SHORT") || 0 == strcmp(sig->method_name, "MIRATH-TCITH-5B-SHORT")) {
		// signed_msg = signature || msg
		*signed_msg_len = signature_len + msg_len;
		*signed_msg = OQS_MEM_malloc(*signed_msg_len);
		if (*signed_msg == NULL) {
		...
		*signed_msg = OQS_MEM_malloc(*signed_msg_len);
		...
		memcpy(*signed_msg + signature_len, msg, msg_len);
		return OQS_SUCCESS;
	} else if (0 == strcmp(sig->method_name, "SNOVA_66_15_3")) {
		// signed_msg = signature || msg
		*signed_msg_len = signature_len + msg_len;
		*signed_msg = OQS_MEM_malloc(*signed_msg_len);
		if (*signed_msg == NULL) {
		...
		memcpy(*signed_msg + signature_len, msg, msg_len);
		return OQS_SUCCESS;
	} else if (0 == strcmp(sig->method_name, "SNOVA_75_33_2")) {
		// signed_msg = signature || msg
		*signed_msg_len = signature_len + msg_len;
		*signed_msg = OQS_MEM_malloc(*signed_msg_len);
		if (*signed_msg == NULL) {
		...
		*signed_msg = OQS_MEM_malloc(*signed_msg_len);
		...
		memcpy(*signed_msg + msg_len, signature, signature_len);
		return OQS_SUCCESS;
	} else if (0 == strcmp(sig->method_name, "SDitH-CAT1-SHORT") ||
	           0 == strcmp(sig->method_name, "SDitH-CAT3-SHORT") ||
	           0 == strcmp(sig->method_name, "SDitH-CAT5-SHORT")) {
		*signed_msg_len = signature_len + msg_len;
		*signed_msg = OQS_MEM_malloc(*signed_msg_len);
		if (*signed_msg == NULL) {
			return OQS_ERROR;
		...
		memcpy(*signed_msg + signature_len, msg, msg_len);
		return OQS_SUCCESS;
	} else if (0 == strcmp(sig->method_name, "LESS-252-192")) {
		// signed_msg = signature || msg
		*signed_msg_len = signature_len + msg_len;
		*signed_msg = OQS_MEM_malloc(*signed_msg_len);
		if (*signed_msg == NULL) {
		...
		memcpy(*signed_msg + signature_len, msg, msg_len);
		return OQS_SUCCESS;
	} else if (0 == strcmp(sig->method_name, "LESS-252-68")) {
		// signed_msg = signature || msg
		*signed_msg_len = signature_len + msg_len;
		*signed_msg = OQS_MEM_malloc(*signed_msg_len);
		if (*signed_msg == NULL) {
		...
		memcpy(*signed_msg + signature_len, msg, msg_len);
		return OQS_SUCCESS;
	} else if (0 == strcmp(sig->method_name, "LESS-252-45")) {
		// signed_msg = signature || msg
		*signed_msg_len = signature_len + msg_len;
		*signed_msg = OQS_MEM_malloc(*signed_msg_len);
		if (*signed_msg == NULL) {
		...
		memcpy(*signed_msg + signature_len, msg, msg_len);
		return OQS_SUCCESS;
	} else if (0 == strcmp(sig->method_name, "LESS-400-220")) {
		// signed_msg = signature || msg
		*signed_msg_len = signature_len + msg_len;
		*signed_msg = OQS_MEM_malloc(*signed_msg_len);
		if (*signed_msg == NULL) {
		...
		memcpy(*signed_msg + signature_len, msg, msg_len);
		return OQS_SUCCESS;
	} else if (0 == strcmp(sig->method_name, "LESS-400-102")) {
		// signed_msg = signature || msg
		*signed_msg_len = signature_len + msg_len;
		*signed_msg = OQS_MEM_malloc(*signed_msg_len);
		if (*signed_msg == NULL) {
		...
		memcpy(*signed_msg + signature_len, msg, msg_len);
		return OQS_SUCCESS;
	} else if (0 == strcmp(sig->method_name, "LESS-548-345")) {
		// signed_msg = signature || msg
		*signed_msg_len = signature_len + msg_len;
		*signed_msg = OQS_MEM_malloc(*signed_msg_len);
		if (*signed_msg == NULL) {
		...
		memcpy(*signed_msg + signature_len, msg, msg_len);
		return OQS_SUCCESS;
	} else if (0 == strcmp(sig->method_name, "LESS-548-137")) {
		// signed_msg = signature || msg
		*signed_msg_len = signature_len + msg_len;
		*signed_msg = OQS_MEM_malloc(*signed_msg_len);
		if (*signed_msg == NULL) {
		...
		memcpy(*signed_msg + signature_len, msg, msg_len);
		return OQS_SUCCESS;
	} else if (0 == strcmp(sig->method_name, "SQIsign-353")) {
		// signed_msg = signature || msg
		*signed_msg_len = signature_len + msg_len;
		*signed_msg = OQS_MEM_malloc(*signed_msg_len);
		if (*signed_msg == NULL) {
		...
		memcpy(*signed_msg + signature_len, msg, msg_len);
		return OQS_SUCCESS;
	} else if (0 == strcmp(sig->method_name, "SQIsign-529")) {
		// signed_msg = signature || msg
		*signed_msg_len = signature_len + msg_len;
		*signed_msg = OQS_MEM_malloc(*signed_msg_len);
		if (*signed_msg == NULL) {
		...
		memcpy(*signed_msg + signature_len, msg, msg_len);
		return OQS_SUCCESS;
	} else if (0 == strcmp(sig->method_name, "SQIsign-701")) {
		// signed_msg = signature || msg
		*signed_msg_len = signature_len + msg_len;
		*signed_msg = OQS_MEM_malloc(*signed_msg_len);
		if (*signed_msg == NULL) {
